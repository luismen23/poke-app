...
export default function Types() {
    ...
    return (
        <div className="flex flex-col w-screen h-screen  items-center mt-32">
            <div className='flex w-[20rem] h-[34rem]'>
                ...
                <div className='border-r w-[46%] flex flex-col items-center gap-y-1 border-blue-800'>
                    <span className='border-b mb-1 text-yellow-600/90 border-blue-800'>Strong Against</span>
                    ...
                    <span className='flex gap-1'>
                        ...
                        <span className="w-6 h-6 relative ">
                            <Image src='/img/bug.webp' fill priority sizes='auto' alt='bug' className=""/>
                        </span><span className="w-6 h-6 relative ">
                            <Image src='/img/ice.webp' fill priority sizes='auto' alt='ice' className=""/>
                        </span>
                    </span>
                    <span className='flex gap-1'>
                ...
                <div className='flex flex-col items-center w-[46%] gap-y-1'>
                    <span className='border-b mb-1 text-yellow-600/90 border-blue-800'>Weak Against</span>
                    <span className='flex gap-1'>
                        <span className="w-6 h-6 relative ">
                            <Image src='/img/fire.webp' fill priority sizes='auto' alt='fire' className=""/>
                        </span>
